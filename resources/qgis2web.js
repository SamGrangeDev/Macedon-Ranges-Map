...
map.getView().fit([16105186.851598, -4492063.271315, 16123196.603266, -4482874.526885], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Romsey Map</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_PropertyBoundaries_35,
    colName: 'Address',
    zoom: 10,
    collapsed: true,
    map: map
